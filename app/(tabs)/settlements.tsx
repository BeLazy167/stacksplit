import { Text, YStack, Card, H2, ScrollView, XStack, Avatar } from 'tamagui';
...
const SettlementCard = memo(function SettlementCard({ settlement }: { settlement: Settlement }) {
  ...
  return (
    <Animated.View style={animatedStyle}>
      <Card elevate bordered padding="$4" size="$4" marginVertical="$2">
        <XStack space="$4" alignItems="center">
          ...
          <YStack flex={1}>
            ...
            <Text theme="alt2" fontSize="$3" fontWeight="$4">
              {isPositive ? 'Owes you' : 'You owe'}
            </Text>
          </YStack>

          <Text fontSize="$6" fontWeight="$7" color={isPositive ? '$green10' : '$red10'}>
